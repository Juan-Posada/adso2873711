...
<body class="bg-rose-800 min-h-[100dvh] flex-col flex gap-4 justify-center items-center">
    ...
    <div class="card card-side md:flex-row flex-col bg-base-100 shadow-sm mt-10">
        <figure>
            <img 
        ...
        <div class="card-body w-[360px]">
            <h1 class="border-b-2"><strong>Name :</strong> {{ $pet->name }} </h1>
            ...
            <h2>
                ...
                @if ($pet->active == 0) {
                    <span class="bg-red-900 text-red-200 rounded-md p-1">No</span>
                }
                @else 
                    <span class="bg-green-900 text-green-200 rounded-md p-1">Yes</span>
                @endif
            </h2>
            <h2>
                <strong>Status :</strong>
                @if ($pet->status == 1) {
                    <span class="bg-red-900 text-red-200 rounded-md p-1">Adopted</span>
                }
                @else 
                    <span class="bg-green-900 text-green-200 rounded-md p-1">Unadopted</span>
                @endif
            </h2>
