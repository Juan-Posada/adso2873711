...
@section('content')
    ...
    <main class="bg-[#154869] pt-20 bg-cover w-full min-h-[100dvh] flex flex-col justify-center items-center">
        <div class="bg-[#0006] md:w-10/12 w-full text-white p-10 rounded-lg flex flex-col justify-center items-center">
            ...
            <div class="join mt-4">
                <a href="{{ url('users/create') }}" class="btn btn-success join-item">
                ...
                <a href="{{ url('export/users/pdf') }}" class="btn join-item">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                        <path
                ...
                <a href="{{ url('export/users/excel') }}" class="btn join-item">
                    <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
                        <path
                ...
                <input class="outline-0 rounded-tr-sm rounded-br-sm indent-2 bg-white/10" type="search" name="qsearch"
                    id="qsearch" placeholder="Search..." value="{{ request('qsearch') }}" />
            </div>
                            ...
                            <tr>
                                ...
                                <th>
                                    ...
                                    <a href="javascript:;" class="btn btn-ghost hover:bg-[transparent] btn-xs">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-4" fill="#fa627a"
                                            viewBox="0 0 256 256">
                                            <path
